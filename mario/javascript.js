...
function fireball() {
  ...
  if (playerMove == 0 && marioHP != 0) {
    ...
    if (miss <= 5) {
      ...
      let snd = new Audio("./music/fireball.mp3");
      snd.play();
      ...
      if (bowserHP == 0) {
        ...
        bgmusic.pause(); 
        let snd = new Audio("./music/victory.mp3");
        snd.play();
        let win = new Audio ("./music/iwin.mp3");
        win.play(); 
      }
    }
    playerMove = 1;
...
function spinthrow() {
  ...
  if (playerMove == 0 && marioHP != 0) {
    ...
    if (miss == 1) {
      ...
      let snd = new Audio("./music/spinthrow.mp3");
      snd.play();
...
function plummerpunch() {
  ...
  if (playerMove == 0 && marioHP != 0) {
    ...
    if (miss == 1) {
      ...
      let snd = new Audio("./music/plummerpunch.mp3");
      snd.play();
...
function jumpon() {
  ...
  if (playerMove == 0 && marioHP != 0) {
    ...
    if (miss == 1) {
      ...
      let snd = new Audio("./music/jump.mp3");
      snd.play();
...
function flameThrower() {
  ...
  if (miss == 1) {
    ...
    let snd = new Audio("./music/flamethrower.mp3");
    snd.play();
    ...
    if (marioHP == 0) {
      ...
      document.getElementById("bjr").style.WebkitAnimationPlayState = "paused";
      bgmusic.pause(); 
      let snd = new Audio("./music/gameover.mp3");
      snd.play();
      let lose = new Audio("./music/uhoh.mp3"); 
      lose.play(); 
    }
  }
}
...
function clawslash() {
  ...
  if (miss == 1) {
    ...
    let snd = new Audio("./music/clawslash.mp3");
    snd.play();
    ...
    if (marioHP == 0) {
      ...
      let snd = new Audio("./music/gameover.mp3");
      snd.play();
      let lose = new Audio("./music/ilose.mp3"); 
      lose.play();
    }
  }
}
...
function kidnap() {
  let snd = new Audio("./music/kidnap.mp3");
  snd.play();
...
function toybomb() {
  ...
  if (miss == 1) {
    ...
    let snd = new Audio("./music/toybomb.mp3");
    snd.play();
